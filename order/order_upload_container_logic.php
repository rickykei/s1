...
$result = mysql_query("SELECT * FROM container where creation_date >= DATE_SUB(NOW(),INTERVAL 1 YEAR) order by id desc" ,$db) or die (mysql_error()."<br />Couldn't execute query: $query");
