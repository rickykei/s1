...
<!-- Top left -->
    <div class="container-top" style="width:290px; float:left;" >
    	<div style="height:310px; overflow:hidden; ">
			<table width="286" border="0" cellspacing="" cellpadding="0" >
				<tr valign="top" >
	...
	<div class="container-top" style="width: 302px; float:left">
    	...
    	<div>
    		<table>
				...
				<div style="height:30px; overflow:hidden;border:0px solid black;">
   			<table>
   				<tr valign="bottom" >
...
<!-- Bottom left -->
	<div class="container-bottom" style="width:290px; float:left;">
    	<div style="height:235px; overflow:hidden;">
   		...
   		<div style="height:50px; overflow:hidden;border:0px solid black;">
   			<table>
   				<tr valign="bottom" >
   					<td width="204" height="50">
						<div align="center">
							<span class="style11">a<? echo "". $ship_row['check_shipping_jp'];?>a</span>
							<span class="style6">a<? echo "". $ship_row['check_shipping_jp'];?>a</span>
						</div>
...
<!-- Bottom middle -->
    <div class="container-bottom" style="width:302px; float:left;">
    	<div style="height:235px; overflow:hidden;">
